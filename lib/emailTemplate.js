...
// Renders the order as an invoice/bill: business + customer details, an
// itemized line-item table, and totals — sent to the business inbox as the
// permanent order record (there's no database in this project).
              ...
              <td style="background:#151315;padding:24px 28px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td align="right" style="color:#C99A2E;font-size:13px;font-weight:700;letter-spacing:0.05em;">NEW COD ORDER</td>
                  </tr>
                </table>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:22px 28px 0;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      <div style="font-size:11px;color:#6E6462;letter-spacing:0.05em;font-weight:700;">INVOICE / ORDER NO.</div>
